...
public class ScoreTools
{
    ...
    public static void CreateMatchScore(SQLInteraction interactionHelper, DataTypes.MatchScore score)
    {
    ...
    public static void CreateQualifierScore(SQLInteraction interactionHelper, DataTypes.QualifierScore score)
    {
